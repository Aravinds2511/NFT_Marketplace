...
export default function Home() {
  ...
  async function loadNFTs() {
    ...
    //map over items to fetch meta data and formatting
  ...
  return (
    <div className="flex justify-center">
      <div className="px-4 " style={{ maxWidth: "1600px" }}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
          {nfts.map((nft, i) => (
